    ...
    <div className="error-svg">
      ...
      >
        <defs>
          ...
          >
            <stop offset="0" stopColor="#4d6de3" />
            <stop offset="0.3" stopColor="#7c9eff" />
            <stop offset="0.6" stopColor="#4d6de3" />
            <stop offset="0.8" stopColor="#8bb3ff" />
            <stop offset="1" stopColor="#4d6de3" />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop offset="0" stopColor="#4d6de3" />
            <stop offset="0.2" stopColor="#6b8aff" />
            <stop offset="0.5" stopColor="#9bb5ff" />
            <stop offset="0.8" stopColor="#4d6de3" />
            <stop offset="1" stopColor="#3a5bc7" />
          </linearGradient>
          <filter
            id="hy-filter"
            x="275"
          ...
          >
            ...
            <feFlood result="flood" floodColor="#4d6de3" floodOpacity="0.6" />
